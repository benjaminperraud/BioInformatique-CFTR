...
BASE_URL = "http://www.ebi.ac.uk:80/interpro/api/protein/reviewed/entry/InterPro/IPR003593/taxonomy/uniprot/9606/?page_size=200"
...
def output_list():
    ...
    while next:
        ...
        for i, item in enumerate(payload["results"]):
            ...
            sys.stdout.write(parse_column(item["metadata"]["source_organism"]["scientificName"],
            ...
            sys.stdout.write(parse_column(item["entries"][0]["entry_protein_locations"],
